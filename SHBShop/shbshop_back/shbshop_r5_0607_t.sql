...
CREATE TABLE `creceipt2p` (
  ...
  `reason` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '결제진행중',
  `createAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `payment_key` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `amount` int NOT NULL,
...
-- Dump completed on 2025-06-07  2:18:34
...
CREATE TABLE `chatmessage` (
  ...
  `img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `createAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`cmid`),
